...
export function RecetaCard({ receta, onClick, onEliminar }: RecetaCardProps) {
  ...
  return (
      <Card
        className="cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-[1.02] border-2 hover:border-primary/50 group relative" // ← AÑADIDAS "group" y "relative"
        onClick={onClick}
      >
      ...
      <CardContent className="pt-0">
        ...
        <button
          ...
          className="absolute top-6 right-16 p-2.5 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-full opacity-0 group-hover:opacity-100 transition-all z-10"
